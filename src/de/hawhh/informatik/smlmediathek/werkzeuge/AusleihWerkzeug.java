...
import de.hawhh.informatik.sml.mediathek.service.ProtokollierException;
import de.hawhh.informatik.sml.mediathek.service.ServiceObserver;
...
class AusleihWerkzeug
{
    ...
    private void leiheAusgewaehlteMedienAus()
    {
        ...
        try 
        {
        	...
        	JOptionPane.showMessageDialog(null, "Kann kein Protokoll schreiben. Keine Schreibrechte?",
