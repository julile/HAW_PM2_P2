        ...
        VerleihService
{
    ...
    public void nimmZurueck(List<Medium> medien, Datum rueckgabeDatum) throws ProtokollierException
    {
        ...
        for (Medium medium : medien)
        {
        	try
        	{
        		VerleihProtokollierer.protokolliere(VerleihProtokollierer.VerleihEreignis.RUECKNAHME, getVerleihkarteFuer(medium));
    ...
    public void verleiheAn(Kunde kunde, List<Medium> medien, Datum ausleihDatum) throws ProtokollierException
    {
        ...
        for (Medium medium : medien)
        {
            ...
            try {
            	VerleihProtokollierer.protokolliere(VerleihProtokollierer.VerleihEreignis.AUSLEIHE, verleihkarte);
            } catch (ProtokollierException e){
            	throw e;        		
            }
        }
